...
namespace Ufba.Ev
{
	...
	/// </remarks>
	public partial class EvHelpKeywordHelper : EvHelpKeywordHelperBase 
	{
		
		/// <summary>
		/// Constructs a new EvHelpKeywordHelper.
		/// </summary>
		protected EvHelpKeywordHelper()
			: base() { }
			
		/// <summary>
		/// Single instance of the EvHelpKeywordHelper.
		/// </summary>
		public static EvHelpKeywordHelper Instance
		{
			get
			{
	...
	/// </summary>
	public abstract class EvHelpKeywordHelperBase
	{
		private global::System.Collections.Generic.Dictionary<string, string> helpKeywords;
		
		/// <summary>
		/// Constructs a new EvHelpKeywordHelperBase.
		/// </summary>
		protected EvHelpKeywordHelperBase()
			: base() { }
