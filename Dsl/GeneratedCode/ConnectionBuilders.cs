...
namespace Ufba.Ev
{
	...
	/// </summary>
	public static partial class OptionConn
	{
		...
		public static bool CanAcceptSource(DslModeling::ModelElement candidate)
		{
			...
			else if (candidate is global::Ufba.Ev.Option)
			{ 
				return true;
			}
			else
		...
		{
			if (candidate == null) return false;
			else if (candidate is global::Ufba.Ev.Function)
			{ 
				return true;
			}
			else
			...
			else // Check combinations
			{
				if (candidateSource is global::Ufba.Ev.Option)
				{
					if (candidateTarget is global::Ufba.Ev.Function)
					{
						...
						if(targetFunction == null || global::Ufba.Ev.OptionHasFunctions.GetLinkToOption(targetFunction) != null) return false;
						if(targetFunction == null || sourceOption == null || global::Ufba.Ev.OptionHasFunctions.GetLinks(sourceOption, targetFunction).Count > 0) return false;
						return true;
					}
				}
	...
	/// </summary>
	internal partial class OptionRelationshipConnectAction : DslDiagrams::ConnectAction
	{
		private DslDiagrams::ConnectionType[] connectionTypes;
		
		/// <summary>
		/// Constructs a new OptionRelationshipConnectAction for the given Diagram.
		/// </summary>
		public OptionRelationshipConnectAction(DslDiagrams::Diagram diagram): base(diagram, true) 
		{
		}
		...
		/// <summary>
		/// Returns the OptionRelationshipConnectionType associated with this action.
		/// </summary>
		protected override DslDiagrams::ConnectionType[] GetConnectionTypes(DslDiagrams::ShapeElement sourceShapeElement, DslDiagrams::ShapeElement targetShapeElement)
		{
			...
			{
				this.connectionTypes = new DslDiagrams::ConnectionType[] { new OptionRelationshipConnectionType() };
			}
			
			return this.connectionTypes;
		}
		
		private partial class OptionRelationshipConnectionTypeBase : DslDiagrams::ConnectionType
		{
			/// <summary>
			/// Constructs a new the OptionRelationshipConnectionType with the given ConnectionBuilder.
			/// </summary>
			protected OptionRelationshipConnectionTypeBase() : base() {}
			...
			/// </summary>
			/// <remarks>
			/// This implementation delegates calls to the ConnectionBuilder OptionConn.
			/// </remarks>
			public override bool CanCreateConnection(DslDiagrams::ShapeElement sourceShapeElement, DslDiagrams::ShapeElement targetShapeElement, ref string connectionWarning)
			{
				...
				{				
					if(targetShapeElement == null)
					{
						return OptionConn.CanAcceptSource(sourceElement);
					}
					else
					{				
						return OptionConn.CanAcceptSourceAndTarget(sourceElement, targetElement);
					}
				}
				else
				{
			...
			public override void CreateConnection(DslDiagrams::ShapeElement sourceShapeElement, DslDiagrams::ShapeElement targetShapeElement, DslDiagrams::PaintFeedbackArgs paintFeedbackArgs)
			{
				...
				if(targetElement == null) targetElement = targetShapeElement;
				OptionConn.Connect(sourceElement, targetElement);
			}
		}
		
		private partial class OptionRelationshipConnectionType : OptionRelationshipConnectionTypeBase
		{
			/// <summary>
			/// Constructs a new the OptionRelationshipConnectionType with the given ConnectionBuilder.
			/// </summary>
			public OptionRelationshipConnectionType() : base() {}
		}
	}
}
