...
namespace Ufba.Ev
{
	...
	/// </remarks>
	public partial class EvToolboxHelper : EvToolboxHelperBase 
	{
		/// <summary>
		/// Constructs a new EvToolboxHelper.
		/// </summary>
		public EvToolboxHelper(global::System.IServiceProvider serviceProvider)
	...
	public abstract class EvToolboxHelperBase
	{
		/// <summary>
		/// Toolbox item filter string used to identify Ev toolbox items.  
		/// </summary>
		/// <remarks>
		...
		/// <summary>
		/// Constructs a new EvToolboxHelperBase.
		/// </summary>
		protected EvToolboxHelperBase(global::System.IServiceProvider serviceProvider)
		{
		...
		public static string DefaultToolboxTabName
		{
			get
			{
				return global::Ufba.Ev.EvDomainModel.SingletonResourceManager.GetString("EvToolboxTab", global::System.Globalization.CultureInfo.CurrentUICulture);
			}
		}
		...
		protected DslModeling::Store ToolboxStore
		{
			...
			{ 
				if (toolboxStore==null)
				{
					...
					toolboxStore.LoadDomainModels(typeof(global::Ufba.Ev.EvDomainModel));
