...
namespace Ufba.Ev
{
	...
	/// </summary>
	[global::System.Runtime.InteropServices.Guid(Constants.EvEditorFactoryId)]
	internal partial class EvEditorFactory : EvEditorFactoryBase
	{
		/// <summary>
		/// Constructs a new EvEditorFactory.
		/// </summary>
		public EvEditorFactory(global::System.IServiceProvider serviceProvider)
	...
	/// </summary>
	internal abstract class EvEditorFactoryBase : DslShell::ModelingEditorFactory
	{
		/// <summary>
		/// Constructor.
		/// </summary>
		/// <param name="serviceProvider">Service provider used to access VS services.</param>
		protected EvEditorFactoryBase(global::System.IServiceProvider serviceProvider) : base(serviceProvider)
		{
		}
		...
		public override DslShell::ModelingDocData CreateDocData(string fileName, VSShellInterop::IVsHierarchy hierarchy, uint itemId)
		{
			...
			return new EvDocData(this.ServiceProvider, typeof(EvEditorFactory).GUID);
		}
		...
		protected override DslShell::ModelingDocView CreateDocView(DslShell::ModelingDocData docData, string physicalView, out string editorCaption)
		{
			...
			return new EvDocView(docData, this.ServiceProvider);
		}
	}
}
