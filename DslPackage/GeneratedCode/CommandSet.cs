...
namespace Ufba.Ev
{
	...
	/// </summary>
	internal partial class EvCommandSet : EvCommandSetBase
	{
		/// <summary>
		/// Constructs a new EvCommandSet.
		/// </summary>
		public EvCommandSet(global::System.IServiceProvider serviceProvider) 
	...
	/// </summary>
	internal abstract class EvCommandSetBase : DslShell::CommandSet
	{
		/// <summary>
		/// Constructs a new EvCommandSetBase.
		/// </summary>
		protected EvCommandSetBase(global::System.IServiceProvider serviceProvider) : base(serviceProvider)
		{
		}
		...
		protected override global::System.Collections.Generic.IList<global::System.ComponentModel.Design.MenuCommand> GetMenuCommands()
		{
			...
			menuCommand = new DslShell::CommandContextBoundMenuCommand(this.ServiceProvider,
				...
				Constants.ViewEvExplorerCommand,
				typeof(EvEditorFactory).GUID);
		...
		{
			EvExplorerToolWindow explorer = this.EvExplorerToolWindow;
			if (explorer != null)
			{
				explorer.Show();
			}
		...
		{
			if (this.CurrentEvDocData != null && this.CurrentEvDocData.Store != null)
			{
				this.CurrentEvDocData.ValidationController.Validate(this.CurrentEvDocData.GetAllElementsForValidation(), DslValidation::ValidationCategories.Menu);
			}
		}
		...
		internal virtual void OnMenuValidate(object sender, global::System.EventArgs e)
		{
			if (this.CurrentEvDocData != null && this.CurrentEvDocData.Store != null)
			{
				...
				this.CurrentEvDocData.ValidationController.Validate(elementList, DslValidation::ValidationCategories.Menu);
			}
		}
		...
		protected EvDocData CurrentEvDocData
		{
			get
			{
				return this.MonitorSelection.CurrentDocument as EvDocData;
			}
		}
		...
		/// </summary>
		[global::System.Diagnostics.CodeAnalysis.SuppressMessage("Microsoft.Performance", "CA1811:AvoidUncalledPrivateCode")]
		protected EvDocView CurrentEvDocView
		{
			get
			{
				return this.MonitorSelection.CurrentDocumentView as EvDocView;
			}
		}
		...
		/// </summary>
		protected EvExplorerToolWindow EvExplorerToolWindow
		{
			get
			{
				EvExplorerToolWindow explorerWindow = null;
				DslShell::ModelingPackage package = this.ServiceProvider.GetService(typeof(VSShell::Package)) as DslShell::ModelingPackage;

				if (package != null)
				{
					explorerWindow = package.GetToolWindow(typeof(EvExplorerToolWindow), true) as EvExplorerToolWindow;
				}
		...
		protected object ExplorerSelection
		{
			get
			{
				...
				EvExplorerToolWindow explorerWindow = this.EvExplorerToolWindow;
	...
	/// Double-derived class to allow easier code customization.
	/// </summary>
	internal partial class EvClipboardCommandSet : EvClipboardCommandSetBase
	{
		/// <summary>
		/// Constructs a new EvClipboardCommandSet.
		/// </summary>
		public EvClipboardCommandSet(global::System.IServiceProvider serviceProvider)
			: base(serviceProvider)
		{
		}
	}
	...
	/// </summary>
	internal abstract partial class EvClipboardCommandSetBase : DslShell::ClipboardCommandSet
	{
		/// <summary>
		/// Constructs a new EvClipboardCommandSetBase.
		/// </summary>
		protected EvClipboardCommandSetBase(global::System.IServiceProvider serviceProvider)
			: base(serviceProvider)
		{
		}
