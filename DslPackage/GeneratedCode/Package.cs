...
namespace Ufba.Ev
{
	...
	[VSShell::ProvideToolWindow(typeof(EvExplorerToolWindow), MultiInstances = false, Style = VSShell::VsDockStyle.Tabbed, Orientation = VSShell::ToolWindowOrientation.Right, Window = "{3AE79031-E1BC-11D0-8F78-00A0C9110057}")]
	[VSShell::ProvideToolWindowVisibility(typeof(EvExplorerToolWindow), Constants.EvEditorFactoryId)]
	[VSShell::ProvideStaticToolboxGroup("@EvToolboxTab;Ufba.Ev.Dsl.dll", "Ufba.Ev.EvToolboxTab")]
	[VSShell::ProvideStaticToolboxItem("Ufba.Ev.EvToolboxTab",
					"@OptionElementToolboxItem;Ufba.Ev.Dsl.dll", 
					"Ufba.Ev.OptionElementToolboxItem", 
					"CF_TOOLBOXITEMCONTAINER,CF_TOOLBOXITEMCONTAINER_HASH,CF_TOOLBOXITEMCONTAINER_CONTENTS", 
					"CreateExampleClassF1Keyword", 
					"@OptionElementToolboxBitmap;Ufba.Ev.Dsl.dll", 
					0xff00ff,
					Index = 0)]
	[VSShell::ProvideStaticToolboxItem("Ufba.Ev.EvToolboxTab",
	...
	[DslShell::ProvideXmlEditorChooserBlockSxSWithXmlEditor(@"Ev", typeof(EvEditorFactory))]

	internal abstract partial class EvPackageBase : DslShell::ModelingPackage
	{
		protected global::Ufba.Ev.EvToolboxHelper toolboxHelper;	
		...
		protected override void Initialize()
		{
			...
			this.RegisterEditorFactory(new EvEditorFactory(this));
			
			// Initialize the toolbox helper
			toolboxHelper = new global::Ufba.Ev.EvToolboxHelper(this);

			// Create the command set that handles menu commands provided by this package.
			EvCommandSet commandSet = new EvCommandSet(this);
			commandSet.Initialize();
			
			// Create the command set that handles cut/copy/paste commands provided by this package.
			EvClipboardCommandSet clipboardCommandSet = new EvClipboardCommandSet(this);
			clipboardCommandSet.Initialize();
			
			// Register the model explorer tool window for this DSL.
			this.AddToolWindow(typeof(EvExplorerToolWindow));
...
namespace Ufba.Ev
{
	...
	[global::Microsoft.VisualStudio.TextTemplating.VSHost.ProvideDirectiveProcessor(typeof(global::Ufba.Ev.EvDirectiveProcessor), global::Ufba.Ev.EvDirectiveProcessor.EvDirectiveProcessorName, "A directive processor that provides access to Ev files")]
	[global::System.Runtime.InteropServices.Guid(Constants.EvPackageId)]
	internal sealed partial class EvPackage : EvPackageBase
	{
	}
}