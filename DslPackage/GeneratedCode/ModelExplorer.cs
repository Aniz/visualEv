...
namespace Ufba.Ev
{
	...
	/// </summary>
	internal partial class EvExplorer : EvExplorerBase
	{
		/// <summary>
		/// Constructs a new EvExplorer.
		/// </summary>
		public EvExplorer(global::System.IServiceProvider serviceProvider)
	...
	/// <summary>
	/// Control hosted in the EvExplorerToolWindow.
	/// </summary>
	internal abstract class EvExplorerBase : DslShell::ModelExplorerTreeContainer
	{
		/// <summary>
		/// Constructs a new EvExplorerBase.
		/// </summary>
		protected EvExplorerBase(global::System.IServiceProvider serviceProvider) : base(serviceProvider)
		{
		...
		protected override global::System.ComponentModel.Design.CommandID ContextMenuCommandId
		{
			get
			{
				return Constants.EvExplorerMenu;
			}
		}
		...
		{
			get { return global::Ufba.Ev.EvModel.DomainClassId; }
		}
